...
# Devuelve "True" o "False" en funciÛn de si la canciÛn est· entre las favoritas del usuario
...
# TODO: AÔøΩadir el artista directamente
...
class RegisterUserSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def create(self, validated_data):
        user = S7_user.objects.create(
            ...
            #email=validated_data['email'], # si aÒadimos mas
...
#Necesario para devolver los trending podcast din√°micos
